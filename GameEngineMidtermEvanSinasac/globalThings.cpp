...
//tanks can start moving
bool tanksStart = false;

//glm::vec3 g_cameraEye = glm::vec3(0.0f, 0.0f, +4.0f);
//glm::vec3 g_cameraAt = glm::vec3(0.0f, 0.0f, 0.0f);
//glm::vec3 cameraEye = glm::vec3(50.0f, 50.0f, -50.0f);
//glm::vec3 cameraTarget = glm::vec3(0.0f, -0.5f, 1.0f);
...
//List of tanks
cTank* g_pPlayerTank = NULL;
std::vector< cTank* > g_vec_pTanks;
